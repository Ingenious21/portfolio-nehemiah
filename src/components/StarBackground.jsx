...
export const StarBackground = () => {
  ...
  // Programming icons with improved light theme visibility
  const programmingIconsData = useMemo(() => [
    { 
      ...
      color: "#E34F26",
      isDark: false,
      lightModeFilter: "brightness(0.8) contrast(1.2) drop-shadow(0 0 4px rgba(0,0,0,0.4))",
    ...
    { 
      ...
      color: "#1572B6",
      isDark: false,
      lightModeFilter: "brightness(0.7) contrast(1.3) drop-shadow(0 0 6px rgba(0,0,0,0.5))",
    ...
    { 
      ...
      color: "#F7DF1E",
      isDark: false,
      lightModeFilter: "brightness(0.6) contrast(1.4) drop-shadow(0 0 8px rgba(0,0,0,0.6))",
    ...
    { 
      ...
      color: "#61DAFB",
      isDark: false,
      lightModeFilter: "brightness(0.7) contrast(1.2) drop-shadow(0 0 6px rgba(0,0,0,0.4))",
  ...
  const generateStars = useCallback(() => {
    const numberOfStars = Math.min(
      ...
      50 // Cap at 50 stars for performance
    );
  ...
  const generateMeteors = useCallback(() => {
    const numberOfMeteors = 3; // Reduced from 4 for better performance
    const newMeteors = [];
    ...
    for (let i = 0; i < numberOfMeteors; i++) {
      newMeteors.push({
        ...
        x: Math.random() * 100,
        y: Math.random() * 20,
        delay: Math.random() * 20 + i * 5, // Spread out delays more
  ...
  const generateProgrammingIcons = useCallback(() => {
    ...
    for (let i = 0; i < numberOfIcons; i++) {
      ...
      newIcons.push({
        ...
        y: Math.random() * 80 + 10,
        size: window.innerWidth < 640 ? 32 : window.innerWidth < 1024 ? 45 : 55,
        opacity: Math.random() * 0.3 + 0.4, // 0.4-0.7 opacity
        animationDuration: Math.random() * 15 + 25, // 25-40s duration
          ...
          {programmingIcons.map((icon) => (
            <div
              ...
              style={{
                ...
                color: icon.color,
                filter: icon.lightModeFilter || `drop-shadow(0 4px 8px rgba(0,0,0,0.25)) drop-shadow(0 2px 4px ${icon.color}33)`,
                willChange: "transform, opacity",
              }}
