...
export const StarBackground = () => {
  ...
  // Programming icons with their brand colors - UPDATED with explicit fill colors
  const programmingIconsData = [
    ...
    { 
      ...
      color: "#1572B6",
      isDark: false,
      svg: `<svg viewBox="0 0 24 24" fill="#1572B6"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm4.133 4.568l2.83 31.704 8.536-2.363 8.566-2.364L8.63 4.568z M5.35 9.5l.458 4.91 9.673.046.186-2.297H9.384l.148-1.665 9.899-.046-.639 7.001-3.514.921-3.514-.921-.23-2.613H9.206l.437 4.68 6.357 1.764 6.357-1.764L21.35 9.5H5.35z"/></svg>`
    },
    { 
      name: "JavaScript", 
      symbol: "JS", 
    ...
    { 
      ...
      color: "#092E20",
      isDark: true,
      svg: `<svg viewBox="0 0 24 24" fill="#092E20"><path d="M11.146 0h3.924v18.166c-2.013.382-3.491.535-5.096.535-4.791 0-7.288-2.166-7.288-6.32 0-4.002 2.65-6.6 6.753-6.6.637 0 1.121.051 1.707.204V0zm0 9.143a3.894 3.894 0 00-1.325-.204c-1.988 0-3.134 1.223-3.134 3.364 0 2.09 1.096 3.236 3.109 3.236.433 0 .79-.025 1.35-.102V9.143zM21.314 6.06v9.098c0 3.134-.229 4.638-.917 5.937-.637 1.249-1.478 2.039-3.211 2.905l-3.644-1.733c1.733-.815 2.574-1.53 3.109-2.625.561-1.121.739-2.421.739-5.835V6.061h3.924zM17.39.021h3.924v4.026H17.39V.021z"/></svg>`
    },
    { 
      name: "Node.js", 
      symbol: "NODE", 
    ...
    { 
      ...
      color: "#000000",
      isDark: true,
      svg: `<svg viewBox="0 0 24 24" fill="#000000"><path d="M24 18.588a1.529 1.529 0 01-1.895-.72l-3.45-4.771-.5-.667-4.003 5.444a1.466 1.466 0 01-1.802.708l5.158-6.92-4.798-6.251a1.595 1.595 0 011.9.666l3.576 4.83 3.596-4.81a1.435 1.435 0 011.788-.668L21.708 7.9l-2.522 3.283a.666.666 0 000 .994l4.804 6.412zM.002 11.576l.42-2.075c1.154-4.103 5.858-5.81 9.094-3.27 1.895 1.489 2.368 3.597 2.275 5.973H1.116C.943 16.447 4.005 19.009 7.92 17.7a4.078 4.078 0 002.582-2.876c.207-.666.548-.78 1.174-.588a5.417 5.417 0 01-2.589 3.957c-6.454 3.078-14.082-2.230-9.085-8.617z"/></svg>`
    }
  ];
  ...
  const generateProgrammingIcons = () => {
    ...
    for (let i = 0; i < numberOfIcons; i++) {
      ...
      newIcons.push({
        ...
        x: Math.random() * 90 + 5,
        y: Math.random() * 90 + 5,
        size: Math.random() * 25 + 35, // 35-60px
        opacity: Math.random() * 0.4 + 0.3, // 0.3-0.7 opacity
        animationDuration: Math.random() * 20 + 30, // 30-50s duration
          ...
          {programmingIcons.map((icon) => (
            <div
              ...
              style={{
                ...
                color: icon.color,
                filter: `drop-shadow(0 4px 8px rgba(0,0,0,0.25)) drop-shadow(0 2px 4px ${icon.color}33)`,
              }}
